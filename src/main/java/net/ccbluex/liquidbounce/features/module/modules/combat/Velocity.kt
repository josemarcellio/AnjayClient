...
class Velocity : Module() {
    ...
    private val modeValue = ListValue("Mode", arrayOf("Cancel", "Custom", "AACv4", "AAC4Reduce", "AAC5Reduce", "AAC5.2.0", "AAC", "AACPush", "AACZero",
        "Reverse", "SmoothReverse", "Jump", "Glitch", "Phase", "Matrix", "Legit",  "AEMine"), "Custom") // later
